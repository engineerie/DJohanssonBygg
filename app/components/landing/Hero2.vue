  ...
  <div class="border-b border-primary-500/30">
    ...
    <UContainer class="sm:border-x border-daniel-500/30">
      ...
      <UPageHero orientation="vertical" :ui="{
        ...
        title: 'saturate-150  max-w-2xl mx-auto text-4xl sm:text-5xl lg:text-6xl text-left sm:text-center  dark:text-white',
        description: 'dark:text-daniel-300 text-daniel-800 text-left sm:text-center sm:text-lg',
        links: 'mt-4 flex-col justify-center items-start sm:items-center '
        ...
        class=" rounded-full size-18 mb-2 ring ring-default ring-offset-3 ring-offset-(--ui-bg)" /> -->
        ...
        delay: 0.5
          ...
          <div v-if="page.hero.links" class="flex items-center gap-2">
            ...
            <UButton :color="global.available ? 'neutral' : 'error'" variant="ghost" class="gap-2 pointer-events-none"
        ...
        <!-- <div class="flex justify-center">
          <NuxtImg width="400" height="400" fit="cover" src="/images/Daniel.png" class="  ring ring-primary-500/30 " />
        </div> -->
